...
#favorite latest tweet from user
function tfav(){
  t timeline $1 -l -n 1 | awk '{print $1}' | xargs t favorite;
}

#Powerline
#function _update_ps1() {
#  export PS1="$(/usr/bin/python2 ~/powerline-shell/powerline-shell.py $? 2> ~/error)"
#}
